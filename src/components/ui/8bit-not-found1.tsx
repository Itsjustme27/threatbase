...
export default function NotFound1({
  ...
  return (
    <div
      className={cn(
        "retro grid w-full place-content-center gap-5 bg-background px-4 py-16 text-center md:py-24 min-h-[80vh]",
        className,
      )}
    >
      <div className="retro font-bold text-6xl tracking-tight sm:text-8xl text-white">
        404
      </div>
      ...
      <p className="retro text-muted-foreground text-xs text-slate-400">{description}</p>
